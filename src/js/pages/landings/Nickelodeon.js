...
export class Nickelodeon{
	...
	init(){
     ...
     cargarVideo(){
        ...
        $(".main-div-Logo img").attr("src","assets/img/template/nickelodeon/logo.png");
        ...
        //seccion canales
        $("#multiscreen").attr("src","assets/img/template/nickelodeon/multiscreen.png");
        $("#descripcionLandingsCanales").html("<p>¡Disfruta el contenido de Nickelodeon:<br> episodios completos, juegos, videos exclusivos, webseries y mucho más!</p>");
        $("#container-BlackCards-Landings").css("background", " linear-gradient(0deg, #CA6B1C 0%, #16161B 100%)");

        //seccion tv
        $("#idLanding").html("Nickelodeon Play");
        $("#tvSubtitulo").html("<p>También puedes descargar la app y registrarte con tu usuario y contraseña de Mi Totalplay para que puedas disfrutar de toda la diversión de Nickelodeon Play en cualquier momento.</p>");
        ...
        $('#botonVideo').html('Paquetes con Nickelodeon');
        $('.boton-chat').html('Paquetes con Nickelodeon');
     }
     cargarCarrusel(){
        var htmlcarrusel="";
        for (var i =1; i <11; i++) {
            htmlcarrusel=htmlcarrusel+`<div class="slide">
                <div class="content-image">
                    <img src="assets/img/template/nickelodeon/portada${i}.png" alt="">
    ...
    cargarCanales(){
		var arraycanales=[
            {
                titulo:"Disfruta el contenido de Nickelodeon",
                imgcanal: "assets/img/template/nickelodeon/Tarjeta1.png",
                descripcionCanal:"Episodios completos, juegos, videos exclusivos, webseries y mucho más."
            },  {
                titulo:"Ingresa desde el menú / Apps de tu TV",
                imgcanal: "assets/img/template/nickelodeon/Tarjeta2.png",
                descripcionCanal:"Selecciona Nickelodeon Play para que puedas disfrutar tus episodios favoritos de Nick."
            },  {
                titulo:"Descarga la App de Nickelodeon Play",
                imgcanal: "assets/img/template/nickelodeon/Tarjeta3.png",
