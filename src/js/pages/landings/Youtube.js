...
export class Youtube{
    ...
    cargarVideo(){
        ...
        $(".main-div-Logo img").attr("src","assets/img/template/youtube/logo.jpg");
        $("#descripcionTemplate").html("<p>Youtube son horas y <span>horas del contenido más divertido.</span></p>");
        
        $("#descripcionLandingsCanales").html("<p>Youtube stá incluido en tú paquete sin costo adicional.</p>");
        $("#TvOnDemand_").addClass("main-div-tv");
        
        $("#container-BlackCards-Landings").css("display", "none");/*QUITAR CUANDO SE TENGAN ASSETS*/
        ...
        $("#idLanding").html("Youtube");
        //$("#tvSubtitulo").html("<p>Ingresa ya desde el menú de Apps de tu TV Totalplay y comienza con el increíble contenido de Youtube.</p>");
	...
	setListener(){
		let apuntador=this;
        //$('#logo_').css("display","none");/*QUITAR CUANDO SE TENGAN ASSETS*/
        //$('#logo__').css("display","none");/*QUITAR CUANDO SE TENGAN ASSETS*/
        $('#logo_').css("width","50%");/*QUITAR CUANDO SE TENGAN ASSETS*/
        $('#logo__').css("width","10%");/*QUITAR CUANDO SE TENGAN ASSETS*/
		window.addEventListener("scroll", function (event) {
            ...
            if(scroll > 227){
                ...
                logoNetflix__.style.width = "10%"; /*QUITAR CUANDO SE TENGAN ASSETS*/
            }
            if(scroll< 226){
            ...
            //logoNetflix__.style.display = "none"; /*QUITAR CUANDO SE TENGAN ASSETS*/
        });
