...
export class Tunein{
    ...
    cargarVideo(){
        ...
        $("#descripcionTemplate").html("<p>Tune in son horas y <span>horas del contenido más divertido.</span></p>");
        
        $("#descripcionLandingsCanales").html("<p>Tune in stá incluido en tú paquete sin costo adicional.</p>");
