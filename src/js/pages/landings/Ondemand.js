...
export class Ondemand{
	...
	cargarVideo(){
        $("#videoLanding").attr("src", "assets/media/landings/OnDemand.mp4");
        $(".main-div-Logo img").attr("src","assets/img/template/ondemand/logo.png");
        $("#descripcionTemplate").html("<p>De la pantalla grande, a TU pantalla. Los estrenos más taquilleros, conciertos, especiales, ¡y mucho más!</p>");
        $("#TvOnDemand_").addClass("main-div-tv");
        $("#multisreen").attr("src","assets/img/template/ondemand/multiscreen.png");
        var multi = document.getElementById("multiscreen");
        multi.src = "assets/img/template/ondemand/multiscreen.png";
        $('#descripcionLandingsCanales').html("<p>Descarga la App Totalplay y lleva los mejores estrenos en cualquier dispositivo móvil.<br>Puedes descargar aquí el app para iOS o Android.</p>")
        $("#tvSubtitulo").html("<p>Toma tu control remoto, ingresa a la sección On Demand de tu TV Totalplay, y elige entre cientos de estrenos para disfrutar en familia.</p>");
        $('.boton-chat').css('background','linear-gradient(90deg, #8246AF 0%, #F04E98 100%)');
        $(".boton-chat").html('Explora el catálogo');
        ...
        $('#botonVideo').css('background','linear-gradient(90deg, #8246AF 0%, #F04E98 100%)');
        $('#botonVideo').html('Explora el catálogo');
        $('.div-container-text-title').html("<p>Los mejores estrenos con OnDemand <span>#SoloConTotalplay</span></p>");
        ...
        for (var i =1; i <11; i++) {
            htmlcarrusel=htmlcarrusel+`<div class="slide">
                <div class="content-image">
                    <img src="assets/img/template/ondemand/portada${i}.png" alt="">
    ...
    cargarCanales(){
		var arraycanales=[
            {
                titulo:"¡Estrenos para todos!",
                imgcanal: "assets/img/template/ondemand/Tarjeta1.png",
                descripcionCanal:"Renta en tu TV los estrenos que todos quieren ver. ¡Siempre encontrarás algo que ver!"
            },  {
                titulo:"¡Llévalo a donde quieras!",
                imgcanal: "assets/img/template/ondemand/Tarjeta2.png",
                descripcionCanal:"Disfruta tus rentas donde sea que estés, desde tu App Totalplay o web."
            },  {
                titulo:" ¡Sin complicaciones!",
                imgcanal: "assets/img/template/ondemand/Tarjeta3.png",
                descripcionCanal:"Disfruta ahora, paga en tu estado de cuenta Totalplay."
            }
		]
