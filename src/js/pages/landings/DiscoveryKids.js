...
export class DiscoveryKids{
	...
	init(){
     ...
     cargarVideo(){
        //seccion video
        $("#videoLanding").attr("src", "assets/media/landings/DiscoveryKids.mp4");
        $(".main-div-Logo img").attr("src","assets/img/template/discoverykids/logo.png");
        $("#descripcionTemplate").html("<p>Discovery Kids Plus son horas y <span>horas del contenido más divertido.</span></p>");
        
        //seccion canales
        $("#TvOnDemand_").addClass("main-div-tv");
        $("#multiscreen").attr("src","assets/img/template/discoverykids/multiscreen.png");
        //$("#container-BlackCards-Landings").css("background", "linear-gradient(0deg, #A9295B 0%, rgba(225,62,126,0) 100%)");
        $("#descripcionLandingsCanales").html("<p>Discovery Kids Plus está incluida en tú paquete sin costo adicional.</p>");
        
        //seccion tv
        $("#idLanding").html("Discovery Kids Play");
        ...
        $('#botonVideo').html('Incluida en tú paquete');
        $('.boton-chat').html('Incluida en tú paquete');
     }
     cargarCarrusel(){
        var htmlcarrusel="";
        for (var i =1; i <11; i++) {
            htmlcarrusel=htmlcarrusel+`<div class="slide">
                <div class="content-image">
                    <img src="assets/img/template/discoverykids/portada${i}.png" alt="">
    ...
    cargarCanales(){
		var arraycanales=[
            {
                titulo:"Discovery Kids Plus",
                imgcanal: "assets/img/template/discoverykids/Tarjeta1.png",
                descripcionCanal:"Ofrece a tus hijos la oportunidad de disfrutar los capítulos completos de sus series favoritas y disfrutar de las mejores actividades y juego."
            },  {
                titulo:"Discovery Kids trae a los personajes y shows",
                imgcanal: "assets/img/template/discoverykids/Tarjeta2.png",
                descripcionCanal:"Mini Beat Power Rockers, Peppa Pig, Mi perro Pat, El zoo de Zu, Ricky Zoom y El mundo de Luna, entre otros."
            },  {
                titulo:"Descarga Discovery Kids Plus",
                imgcanal: "assets/img/template/discoverykids/Tarjeta3.png",
                descripcionCanal:"Continúa con la diversión y contenidos interactivos, juegos, así como contenido original, libros digitales (e-books) y actividades educativas."
            }
		]
